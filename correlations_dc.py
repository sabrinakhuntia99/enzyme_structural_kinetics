...
# Read the data file
df = pd.read_csv('../data/collagen_disorder_predictions_output_pdb_model.tsv', sep='\t')
...
plt.title('Distribution of Disorder Content for Collagen Proteins (PDB Model Predictions)', fontsize=16)
